...
CModules::append_onload( __FILE__, 'new DmcIcons1();' );
...
CModules::append( 'mod_js_class_DmcIcons1', <<<EOLONGTEXT


class DmcIcons1 extends DmcBase {
...
EOLONGTEXT );  // mod_js_class_DmcIcons1 
